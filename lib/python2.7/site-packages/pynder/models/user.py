...
class Hopeful(User):
 ...
 def dislike(self):
  ...
  self._session._api.dislike(self.id)
...
class Match(User):
 ...
 def message(self, body):
  return self._session._api.message(self.id+self._session.profile.id, body)['_id']

 def message_2(self, body):
  return self._session._api.message(self.id + self._session.profile.id,body)
